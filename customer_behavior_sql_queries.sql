...
--01. What is the total revenue generated by male vs. female customers? 
  ...
  select gender, sum(purchase_amount) as revnew
  from customers
  group by gender;
...
select item_purchased,ROUND( AVG(review_rating :: numeric), 2) as "average_product_review"
from customers
group by item_purchased
order by AVG(review_rating) desc
limit 5;

--04.Compare the average Purchase Amounts between Standard and and Express Shipping 
